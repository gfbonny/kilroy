...
digraph G {
  ...
  exit  [shape=Msquare]
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
  orphan [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
  start -> a -> exit
  a -> missing
}
`))
...
func TestValidate_ConditionAndStylesheetSyntax(t *testing.T) {
	g, err := dot.Parse([]byte(`
digraph G {
  graph [model_stylesheet="* { llm_provider: openai; } box { llm_model: gpt-5.3-codex; }"]
  start [shape=Mdiamond]
  exit  [shape=Msquare]
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
  start -> a -> exit
...
digraph G {
  start [shape=Mdiamond]
  exit  [shape=Msquare]
  a [shape=box, llm_model=gpt-5.3-codex]
  start -> a -> exit
}
`))
	if err != nil {
...
digraph G {
  ...
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="x"]
  check [shape=diamond]
  pm [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="postmortem"]
  start -> a -> check
...
digraph G {
  ...
  exit [shape=Msquare]
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="x"]
  b [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="y"]
  start -> a -> b
...
digraph G {
  start [shape=Mdiamond]
  exit [shape=Msquare]
  impl [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="x"]
  check [shape=diamond]
  start -> impl -> check
...
digraph G {
  ...
  postmortem [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="p"]
  check -> exit [condition="outcome=success"]
}
`))
	if err != nil {
...
digraph G {
  start [shape=Mdiamond]
  exit  [shape=Msquare]
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="x", escalation_models="kimi:kimi-k2.5, anthropic:claude-opus-4-6"]
  start -> a -> exit
}
`))
	if err != nil {
...
digraph G {
  start [shape=Mdiamond]
  exit  [shape=Msquare]
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="x", escalation_models="kimi-kimi-k2.5"]
  start -> a -> exit
}
`))
	if err != nil {
...
digraph G {
  start [shape=Mdiamond]
  exit  [shape=Msquare]
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="x", escalation_models=":some-model"]
  start -> a -> exit
}
`))
	if err != nil {
...
digraph G {
  ...
  start [shape=Mdiamond]
  exit [shape=Msquare]
  implement [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="x"]
  review_consensus [
    shape=box,
    goal_gate=true,
    llm_provider=openai,
...
digraph G {
  ...
  start [shape=Mdiamond]
  exit [shape=Msquare]
  postmortem [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="pm"]
  implement [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="impl"]
  debate_consolidate [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="debate"]
  start -> postmortem
...
digraph G {
  ...
  postmortem [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="pm"]
  implement [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="impl"]
  plan_fanout [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="plan"]
  check_toolchain [shape=parallelogram, tool_command="echo ok"]
  start -> postmortem
...
digraph G {
  start [shape=Mdiamond]
  exit [shape=Msquare]
  a [shape=box, type=codergen, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="x"]
  start -> a -> exit
}
`))
	if err != nil {
...
digraph G {
  start [shape=Mdiamond]
  exit [shape=Msquare]
  a [shape=box, type=unknown_handler, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="x"]
  start -> a -> exit
}
`))
	if err != nil {
...
digraph G {
  start [shape=Mdiamond]
  exit [shape=Msquare]
  review [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="review"]
  implement [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="impl"]
  start -> review
...
func buildTestCatalog() *modeldb.Catalog {
	return &modeldb.Catalog{
		Models: map[string]modeldb.ModelEntry{
			...
			"openai/gpt-5.3-codex":              {Provider: "openai"},
		},
...
digraph G {
  start [shape=Mdiamond]
  exit  [shape=Msquare]
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="inline text", prompt_file="prompts/some.md"]
  start -> a -> exit
}
`))
	if err != nil {
...
digraph G {
  start [shape=Mdiamond]
  exit  [shape=Msquare]
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt_file="prompts/some.md"]
  start -> a -> exit
}
`))
	if err != nil {
...
func TestPromptFile_LlmPromptConflict_FiresWithLlmPromptAttr(t *testing.T) {
	...
	a.Attrs["llm_model"] = "gpt-5.3-codex"
...
func TestValidate_ReservedKeywordNodeID_WarnsOnIfKeyword(t *testing.T) {
	...
	n.Attrs["llm_model"] = "gpt-5.3-codex"
	_ = g.AddNode(n)
