...
digraph G {
  ...
  verify [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
  join -> verify
}
`))
	if err != nil {
...
digraph G {
  ...
  verify [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
  retry_node [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
  retry_global [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
  join -> verify
}
`))
	if err != nil {
...
digraph G {
  join [shape=tripleoctagon, retry_target="retry_node"]
  retry_by_condition [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
  retry_node [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
  verify [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex]
