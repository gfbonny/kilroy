...
digraph G {
  ...
  exit [shape=Msquare]
  par [shape=component]
  a [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, auto_status=true, prompt="branch a"]
  b [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, auto_status=true, prompt="branch b"]
  merge [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, auto_status=true, prompt="merge branch outputs"]
