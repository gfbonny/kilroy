...
digraph G {
  ...
  exit  [shape=Msquare]
  work  [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="do work"]
  check [shape=diamond]
  start -> work
  work -> check
  check -> exit [condition="outcome=success"]
...
digraph G {
  ...
  start [shape=Mdiamond]
  exit  [shape=Msquare]
  work  [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, max_retries="1", prompt="do work"]
  check [shape=diamond]
  start -> work
  work -> check
  check -> exit [condition="outcome=success"]
...
digraph G {
  ...
  start  [shape=Mdiamond]
  exit   [shape=Msquare]
  impl   [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="implement"]
  verify [shape=box, llm_provider=openai, llm_model=gpt-5.3-codex, prompt="verify"]
  check  [shape=diamond]
